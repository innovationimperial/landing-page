            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {steps.map((step, idx) => (
                        <div
                            key={step.id}
                            className="group relative p-8 md:p-10 rounded-[2.5rem] bg-gradient-glass backdrop-blur-2xl border border-glass-border/[0.06] shadow-glass hover:shadow-card-hover transition-all duration-500 animate-fade-in flex flex-col h-full"
